...
- **Toda resolução que troca unidade desenha a tabela das unidades** (`div.escada` no código, unidades de partida e chegada marcadas com `.aqui`) antes de fazer a conta — a criança não lembrou da escada na 2ª questão do Dia 1 (pedido do Diogo, 21/09). Comprimento, massa e capacidade: ×10/÷10 por casa. **Área: ×100/÷100 por casa; volume: ×1000/÷1000 por casa** — e nessas duas vai uma explicação de 1 linha do porquê (1 m = 10 dm → 1 m² = 10 × 10 = 100 dm² → 1 m³ = 10 × 10 × 10 = 1000 dm³). Ponte capacidade↔volume quando aparecer: 1 L = 1 dm³, 1 mL = 1 cm³, 1 m³ = 1000 L.
- **Nome na página: "tabela das unidades" e "casa"** — nunca "escada" nem "degrau" para a fileira km · hm · dam · m · dm · cm · mm (ela aprendeu como tabela; pedido do Diogo, 26/09). "Degrau" fica reservado para os degraus de dificuldade (oficina, redação).
